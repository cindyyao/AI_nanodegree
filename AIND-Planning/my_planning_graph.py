...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if anode.prenodes.issubset(self.s_levels[level]): # preconditions are satisfied
                for pnode in self.s_levels[level]:
                    if pnode in anode.prenodes: # connect nodes
                        pnode.children.add(anode)
                        anode.parents.add(pnode)
    ...
    def add_literal_level(self, level):
        ...
        # import copy
        # self.s_levels.append(copy.deepcopy(self.s_levels[level - 1]))
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # testing effect node would be enough
        for add1 in action_1.effect_add:
            if add1 in action_2.effect_rem:
                return True
        for rem1 in action_1.effect_rem:
            if rem1 in action_2.effect_add:
                return True
        return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        action_2 = node_a2.action
        for add1 in action_1.effect_add:
            if add1 in action_2.precond_neg:
                return True
        for rem1 in action_1.effect_rem:
            if rem1 in action_2.precond_pos:
                return True
        for add2 in action_2.effect_add:
            if add2 in action_1.precond_neg:
                return True
        for rem2 in action_2.effect_rem:
            if rem2 in action_1.precond_pos:
                return True
        return False
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # The implementation below failed the test, probably because it bypassed
        # PgNode_s.is_mutex method. However, it should work for the real problems??
        #
        # action_1 = node_a1.action
        # action_2 = node_a2.action
        # for pre1pos in action_1.precond_pos:
        #     if pre1pos in action_2.precond_neg:
        #         return True
        # for pre1neg in action_1.precond_neg:
        #     if pre1neg in action_2.precond_pos:
        #         return True
        # return False
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            ...
            for i in range(len(self.s_levels)):
                if goal_node in self.s_levels[i]:
                    level_sum += i
                    break
        return level_sum
